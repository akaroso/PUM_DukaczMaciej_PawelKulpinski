...
namespace KonwerterWalutOnline
{
    ...
    public partial class MainPage : ContentPage, INotifyPropertyChanged
    {
        ...
        private const string Url = "https://openexchangerates.org/api/latest.json?app_id=4f8c9e3f73184fd0a3ec7cfa775f29eb";
        ...
        async void OnConvert(object sender, System.EventArgs e)
        {
            ...
            MoneyClass response = JsonConvert.DeserializeObject<MoneyClass>(content);
